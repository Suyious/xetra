      ...
      <nav className={styles.Navigation}>
        <div className={styles.wrapper}>
          <div className={styles.Nav_left}>
            ...
            <Link href="/">
              <a title="Xetra - Home" className={styles.Nav_logo}>Xetra.</a>
            </Link>
          </div>
